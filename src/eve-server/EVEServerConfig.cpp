...
bool EVEServerConfig::ProcessEveServer( const TiXmlElement* ele )
{
    ...
    AddMemberParser( "bpTimes",   &EVEServerConfig::ProcessBPTimes ); /* legacy alias */
...
bool EVEServerConfig::ProcessBPTimes(const TiXmlElement* ele)
{
    ...
    /* Names used in older eve-server.xml (<bpTimes> block) */
    AddValueParser( "ResRE",            ram.ReTime);
    AddValueParser( "ResCopy",          ram.CopyTime);
    AddValueParser( "ProdMod",          ram.ProdTime);
...
bool EVEServerConfig::ProcessDebug(const TiXmlElement* ele)
{
    ...
    AddValueParser( "StackTrace",           debug.StackTrace ); /* alias; same as UseStackTrace */
