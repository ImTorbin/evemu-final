...
PyDict* SystemEntity::MakeSlimItem() {
    ...
    PyDict *slim = new PyDict();
        // Crucible clients match slim entries to destiny balls via ballID.
        // Default this to itemID for all entities so non-ship objects do not
        // arrive as ballID=0 and break AddBalls state reconstruction.
