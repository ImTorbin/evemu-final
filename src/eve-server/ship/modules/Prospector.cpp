...
void Prospector::DropSalvage()
{
    ...
    InventoryItemRef targetSelf(m_targetSE->GetSelf());
    if ((targetSelf.get() != nullptr) and !targetSelf->GetMyInventory()->IsEmpty()) {
        ...
        shipLoot.clear();
        targetSelf->GetMyInventory()->GetInventoryMap(shipLoot);
        ...
        if (jetCanRef.get() != nullptr) {
            ...
            FactionData data = FactionData();
                ...
                data.ownerID = targetSelf->ownerID();
